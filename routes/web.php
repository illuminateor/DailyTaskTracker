...
Route::middleware('guest')->group(function () {
    ...
    Route::get('/forget-password', [PasswordResetController::class, 'showPasswordResetRequestForm'])
        ->name('password.request');

    Route::post('/forget-password', [PasswordResetController::class, 'sendPasswordResetEmail'])
